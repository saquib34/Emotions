...
import ImageEmotionRadar from '../charts/ImageEmotionRadar';
import ImageEmotionBars from '../charts/ImageEmotionBars';
...
const ResultsSection = ({ results }) => {
  ...
  const emotionDescriptions = {
    ...
    'fear': 'Anxious or scared sentiment',
    ...
    >
      ...
      <div className="space-y-4">
        ...
        <div className="bg-purple-900 bg-opacity-30 rounded-lg p-4">
          {activeChart === 'radar' ? (
            <ImageEmotionRadar emotionData={predictions} />
          ) : (
            <ImageEmotionBars emotionData={predictions} />
          )}
        </div>
      </div>
    </motion.div>
